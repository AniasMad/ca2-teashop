                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 shadow-xl dark:shadow-gray-900">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <form method="POST" action="{{ route('admin.brands.destroy', $brand->id) }}"  class="pb-3">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">Delete Brand</button>
                        </form>
