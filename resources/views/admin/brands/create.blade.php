...
<!-- Create Post Form -->
<div class="px-6 py-3">
    <h4 class="text-2xl font-bold dark:text-white">{{ __('Create Brand') }}</h4>
</div>
<div class="px-6 py-3">
