...
<div class="px-10 py-3">
    <h2 class="text-2xl font-bold dark:text-white">Teashops and teas</h2>
</div>
    ...
    @foreach($teashops as $teashop)
        <div class="w-full md:w-1/4 px-4 mb-4">
            <div class="max-w-sm h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col">
                <a href="{{ route('admin.mainmenu.show', $teashop->id) }}">
                ...
                <div class="p-5 flex flex-col justify-between">
                    ...
                    <a href="{{ route('admin.mainmenu.show', $teashop->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Enter the shop
