...
<!-- Create Post Form -->
<div class="px-6 py-3">
    <h4 class="text-2xl font-bold dark:text-white">{{__('Edit Tea')}}</h4>
</div>
<div class="px-6 py-3">
<form enctype="multipart/form-data" action="{{ route('moderator.teas.update', $tea->id) }}" method="post">
    
    @csrf
    @method('PUT')
    <img width="150" class="mb-4" src="{{ asset("storage/images/" . $tea->image) }}" alt="Current Image">
    <div class="mb-6">
